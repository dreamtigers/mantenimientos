...
CREATE TABLE IF NOT EXISTS `dbpistongps`.`tc_devices` (
...
--
ALTER TABLE `dbpistongps`.`tc_devices`
  ADD CONSTRAINT `fk_devices_groupid` FOREIGN KEY (`groupid`) REFERENCES `dbpistongps`.`tc_groups` (`id`) ON DELETE SET NULL;
