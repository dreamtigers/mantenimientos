...
CREATE TABLE IF NOT EXISTS `dbpistongps`.`tc_positions` (
...
--
ALTER TABLE `dbpistongps`.`tc_positions`
  ADD CONSTRAINT `fk_positions_deviceid` FOREIGN KEY (`deviceid`) REFERENCES `dbpistongps`.`tc_devices` (`id`) ON DELETE CASCADE;
